...
class Ui_FilePage(object):
    def setupUi(self, FilePage):
        ...
        self.building_selector.setGeometry(QtCore.QRect(50, 20, 141, 31))
        ...
        self.new_building_button.setGeometry(QtCore.QRect(240, 20, 56, 31))
        ...
        self.stackedBuilding.setGeometry(QtCore.QRect(0, 60, 341, 600))
