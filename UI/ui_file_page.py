...
class Ui_FilePage(object):
    def setupUi(self, FilePage):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(0, 60, 341, 501))
    ...
    def retranslateUi(self, FilePage):
        ...
        self.floor_box.setTitle(_translate("FilePage", "楼层参数"))
        self.label_floor_thickness.setText(_translate("FilePage", "层间厚度"))
        self.label_floors.setText(_translate("FilePage", "层数"))
        self.label_rooms.setText(_translate("FilePage", "每层房间数"))
        self.room_box.setTitle(_translate("FilePage", "房间参数"))
        self.label_room_width.setText(_translate("FilePage", "房间宽度"))
        self.label_room_height.setText(_translate("FilePage", "房间高度"))
        self.label_room_length.setText(_translate("FilePage", "房间长度    "))
        self.label_wall_thickness.setText(_translate("FilePage", "墙厚度"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.model_page), _translate("FilePage", "Model"))
